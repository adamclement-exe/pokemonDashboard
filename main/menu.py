...
text1 = Label(root,bg='#2E4053', fg='white',font=('times', 11, 'bold'))
...
text2.place(relx=0.06,rely=0.365,relwidth=0.18, relheight=0.09)
...
start_button = Button(frame1, bg='white',font=('times', 11, 'bold'), borderwidth=4,
